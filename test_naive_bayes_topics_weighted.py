...
for x in range(3):
    ...
    train_x = pd.read_csv("topic_weighted_train" + str(x) + ".csv", sep=',', encoding = "ISO-8859-1", engine='python')
    test_x = pd.read_csv("topic_weighted_test" + str(x) + ".csv", sep=',', encoding = "ISO-8859-1", engine='python')
    ...
    submission.to_csv('results_topic_weighted' + str(x) + '.csv', index=False)
