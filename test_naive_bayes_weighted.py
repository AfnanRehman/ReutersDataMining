...
for x in range(3):
    ...
    train_x = pd.read_csv("place_weighted_train" + str(x) + ".csv", sep=',', encoding = "ISO-8859-1", engine='python')
    test_x = pd.read_csv("place_weighted_test" + str(x) + ".csv", sep=',', encoding = "ISO-8859-1", engine='python')
